...
#define UMM_MALLOC_CFG_HEAP_ADDR (da_heap)
#define UMM_MALLOC_CFG_HEAP_SIZE 0x5FFF
...
#define DBGLOG_ERROR(x, ...)
#define DBGLOG_FORCE(x, ...)
#define DBGLOG_DEBUG(x, ...)
#define DBGLOG_TRACE(x, ...)
