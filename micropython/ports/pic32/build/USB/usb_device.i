...
# 1 "<command-line>"
# 1 "USB/usb_device.c"
# 254 "USB/usb_device.c"
# 1 "USB/usb.h" 1
# 110 "USB/usb.h"
# 1 "/opt/microchip/xc32/v1.34/bin/bin/../../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/GenericTypeDefs.h" 1 3
# 63 "/opt/microchip/xc32/v1.34/bin/bin/../../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/GenericTypeDefs.h" 3
...
# 64 "/opt/microchip/xc32/v1.34/bin/bin/../../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/GenericTypeDefs.h" 2 3
...
# 14 "/opt/microchip/xc32/v1.34/bin/bin/../../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/string.h" 3
...
# 88 "USB/../USB/usb_device_local.h"
# 1 "USB/../USB/usb_config.h" 1
# 89 "USB/../USB/usb_device_local.h" 2
# 101 "USB/../USB/usb_device_local.h"
typedef union
{
    struct
    {
...
# 258 "USB/usb_device.c" 2
# 282 "USB/usb_device.c"
...
{
    BYTE i;
# 781 "USB/usb_device.c"
    if(USBDeviceState == ATTACHED_STATE)
    {
# 792 "USB/usb_device.c"
        if(!0)
        {
            U1IR = 0xFF;;
...
void USBDeviceDetach(void)
{
...

    {
         ...
         USBDeviceState = DETACHED_STATE;
# 1464 "USB/usb_device.c"
          return;
    }
# 1485 "USB/usb_device.c"
}
# 1525 "USB/usb_device.c"
void USBDeviceAttach(void)
{
...
static void USBConfigureEndpoint(BYTE EPNum, BYTE direction)
{
    ...
    else
    {
        ...
        handle->STAT.DTS = 0;
        (handle+1)->STAT.DTS = 1;
# 1754 "USB/usb_device.c"
}
# 1785 "USB/usb_device.c"
static void USBCtrlEPServiceComplete(void)
{
...
# 1852 "USB/usb_device.c"
   if(USBDeferINDataStagePackets == FALSE)
            {
                USBCtrlEPAllowDataStage();
   }
# 1877 "USB/usb_device.c"
            USBStatusStageEnabledFlag2 = FALSE;
            USBStatusStageEnabledFlag1 = FALSE;
...
static void USBCtrlTrfRxService(void)
{
 ...
 outPipes[0].wCount.Val = outPipes[0].wCount.Val - byteToRead;
    ...
    else
    {
        ...
        {
# 2087 "USB/usb_device.c"
                outPipes[0].pFunc();

        }
        outPipes[0].info.bits.busy = 0;
# 2104 "USB/usb_device.c"
        if(USBDeferStatusStagePacket == FALSE)
        {
            USBCtrlEPAllowStatusStage();
        }
...
# 2355 "USB/usb_device.c"
static void USBStallHandler(void)
{
# 2368 "USB/usb_device.c"
...
# 2398 "USB/usb_device.c"
static void USBSuspend(void)
{
# 2423 "USB/usb_device.c"
...
# 2475 "USB/usb_device.c"
    U1OTGIEbits.ACTVIE = 0;
# 2495 "USB/usb_device.c"
    {
        (U1OTGIR = (1 << 4));
    }

}
# 2522 "USB/usb_device.c"
static void USBCtrlEPService(void)
{
...
# 2670 "USB/usb_device.c"
    USBCtrlEPServiceComplete();
}
# 2694 "USB/usb_device.c"
static void USBCtrlTrfOutHandler(void)
{
    if(controlTransferState == 2)
    {
