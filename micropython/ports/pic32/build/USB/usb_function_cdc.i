# 1 "USB/usb_function_cdc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "USB/usb_function_cdc.c"
# 105 "USB/usb_function_cdc.c"
# 1 "USB/usb.h" 1
# 110 "USB/usb.h"
...
# 350 "USB/usb_function_cdc.c"
            inPipes[0].info.bits.busy = 1;
            break;
# 375 "USB/usb_function_cdc.c"
        default:
            break;
    }

}
# 413 "USB/usb_function_cdc.c"
void CDCInitEP(void)
{
...
# 465 "USB/usb_function_cdc.c"
    cdc_trf_state = 0;
}
# 543 "USB/usb_function_cdc.c"
BOOL USBCDCEventHandler(USB_EVENT event, void *pdata, WORD size)
{
    switch( (INT)event )
    {
...
# 675 "USB/usb_function_cdc.c"
void putUSBUSART(char *data, BYTE length)
{
# 700 "USB/usb_function_cdc.c"
    {IEC1CLR = 0x00000008;};
    if(cdc_trf_state == 0)
    {
...
# 748 "USB/usb_function_cdc.c"
void putsUSBUSART(char *data)
{
    BYTE len;
    char *pData;
# 776 "USB/usb_function_cdc.c"
    {IEC1CLR = 0x00000008;};
    if(cdc_trf_state != 0)
    {
        {IEC1SET = 0x00000008;};
...
# 845 "USB/usb_function_cdc.c"
void putrsUSBUSART(const const char *data)
{
    BYTE len;
    const const char *pData;
# 873 "USB/usb_function_cdc.c"
    {IEC1CLR = 0x00000008;};
    if(cdc_trf_state != 0)
    {
        {IEC1SET = 0x00000008;};
