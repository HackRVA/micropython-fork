...
void *gc_alloc(size_t n_bytes, _Bool has_finaliser);
...
(const byte*)"\x00\x00" "",
(const byte*)"\x05\x00" "",
(const byte*)"\xc4\x07" "__add__",
(const byte*)"\x2b\x08" "__bool__",
(const byte*)"\x42\x0f" "__build_class__",
(const byte*)"\xa7\x08" "__call__",
(const byte*)"\x2b\x09" "__class__",
(const byte*)"\xc6\x0c" "__contains__",
(const byte*)"\xfd\x0b" "__delitem__",
(const byte*)"\x6d\x09" "__enter__",
(const byte*)"\x71\x06" "__eq__",
(const byte*)"\x45\x08" "__exit__",
(const byte*)"\xa7\x06" "__ge__",
(const byte*)"\x40\x0b" "__getattr__",
(const byte*)"\x26\x0b" "__getitem__",
(const byte*)"\xb6\x06" "__gt__",
(const byte*)"\xf7\x08" "__hash__",
(const byte*)"\x6d\x08" "__iadd__",
(const byte*)"\x38\x0a" "__import__",
(const byte*)"\x5f\x08" "__init__",
(const byte*)"\x08\x08" "__isub__",
(const byte*)"\xcf\x08" "__iter__",
(const byte*)"\xcc\x06" "__le__",
(const byte*)"\xe2\x07" "__len__",
(const byte*)"\x5d\x06" "__lt__",
(const byte*)"\x8e\x08" "__main__",
(const byte*)"\xff\x0a" "__module__",
(const byte*)"\xe2\x08" "__name__",
(const byte*)"\x79\x07" "__new__",
(const byte*)"\x02\x08" "__next__",
(const byte*)"\xc8\x08" "__path__",
(const byte*)"\x6b\x0c" "__qualname__",
(const byte*)"\x01\x0e" "__repl_print__",
(const byte*)"\x10\x08" "__repr__",
(const byte*)"\x32\x0b" "__setitem__",
(const byte*)"\xd0\x07" "__str__",
(const byte*)"\x21\x07" "__sub__",
(const byte*)"\x4f\x0d" "__traceback__",
(const byte*)"\x8f\x01" "*",
(const byte*)"\xfa\x01" "_",
(const byte*)"\x8a\x01" "/",
(const byte*)"\xf5\x05" "{:#o}",
(const byte*)"\x02\x05" "{:#x}",
(const byte*)"\x58\x05" "{:#b}",
(const byte*)"\x85\x01" " ",
(const byte*)"\xaf\x01" "\x0a",
(const byte*)"\x73\x20" "maximum recursion depth exceeded",
(const byte*)"\xbd\x08" "<module>",
(const byte*)"\x80\x08" "<lambda>",
(const byte*)"\xd4\x0a" "<listcomp>",
(const byte*)"\xcc\x0a" "<dictcomp>",
(const byte*)"\x54\x09" "<setcomp>",
(const byte*)"\x34\x09" "<genexpr>",
(const byte*)"\x52\x08" "<string>",
(const byte*)"\xe3\x07" "<stdin>",
(const byte*)"\xb7\x05" "utf-8",
(const byte*)"\x76\x03" "red",
(const byte*)"\xbe\x05" "green",
(const byte*)"\x7b\x04" "blue",
(const byte*)"\xe8\x07" "FbMoveX",
(const byte*)"\xe9\x07" "FbMoveY",
(const byte*)"\xb0\x06" "FbMove",
(const byte*)"\x04\x0e" "FbMoveRelative",
(const byte*)"\xb8\x07" "FbClear",
(const byte*)"\x1c\x07" "FbColor",
(const byte*)"\x98\x0b" "FbCharacter",
(const byte*)"\x2d\x07" "FbPoint",
(const byte*)"\xb2\x0b" "FbWriteLine",
(const byte*)"\x09\x0d" "FbWriteString",
(const byte*)"\x67\x0d" "FbSwapBuffers",
(const byte*)"\x0f\x06" "FbLine",
(const byte*)"\x2d\x0f" "ArithmeticError",
(const byte*)"\x97\x0e" "AssertionError",
(const byte*)"\x21\x0e" "AttributeError",
(const byte*)"\x07\x0d" "BaseException",
(const byte*)"\x91\x08" "EOFError",
(const byte*)"\xf0\x08" "Ellipsis",
(const byte*)"\xf2\x09" "Exception",
(const byte*)"\x16\x0d" "GeneratorExit",
(const byte*)"\x20\x0b" "ImportError",
(const byte*)"\x5c\x10" "IndentationError",
(const byte*)"\x83\x0a" "IndexError",
(const byte*)"\xea\x08" "KeyError",
(const byte*)"\xaf\x11" "KeyboardInterrupt",
(const byte*)"\xff\x0b" "LookupError",
(const byte*)"\xdc\x0b" "MemoryError",
(const byte*)"\xba\x09" "NameError",
(const byte*)"\x17\x08" "NoneType",
(const byte*)"\xc6\x13" "NotImplementedError",
(const byte*)"\xa1\x07" "OSError",
(const byte*)"\x81\x0d" "OverflowError",
(const byte*)"\x61\x0c" "RuntimeError",
(const byte*)"\xea\x0d" "StopIteration",
(const byte*)"\x94\x0b" "SyntaxError",
(const byte*)"\x20\x0a" "SystemExit",
(const byte*)"\x25\x09" "TypeError",
(const byte*)"\x96\x0a" "ValueError",
(const byte*)"\xb6\x11" "ZeroDivisionError",
(const byte*)"\x95\x03" "abs",
(const byte*)"\x44\x03" "all",
(const byte*)"\x13\x03" "any",
(const byte*)"\x6b\x06" "append",
(const byte*)"\xc2\x04" "args",
(const byte*)"\xe0\x03" "bin",
(const byte*)"\xeb\x04" "bool",
(const byte*)"\x97\x0c" "bound_method",
(const byte*)"\xf7\x08" "builtins",
(const byte*)"\x22\x08" "bytecode",
(const byte*)"\x5c\x05" "bytes",
(const byte*)"\x0d\x08" "callable",
(const byte*)"\xdc\x03" "chr",
(const byte*)"\xb4\x0b" "classmethod",
(const byte*)"\x7c\x05" "clear",
(const byte*)"\x33\x05" "close",
(const byte*)"\x74\x07" "closure",
(const byte*)"\xc0\x05" "const",
(const byte*)"\xe0\x04" "copy",
(const byte*)"\xa6\x05" "count",
(const byte*)"\xce\x07" "default",
(const byte*)"\x3f\x04" "dict",
(const byte*)"\x2d\x09" "dict_view",
(const byte*)"\xfa\x03" "dir",
(const byte*)"\xb8\x06" "divmod",
(const byte*)"\x0a\x03" "end",
(const byte*)"\x1b\x08" "endswith",
(const byte*)"\x9b\x04" "eval",
(const byte*)"\x1e\x04" "exec",
(const byte*)"\x63\x06" "extend",
(const byte*)"\x25\x06" "filter",
(const byte*)"\x01\x04" "find",
(const byte*)"\x26\x06" "format",
(const byte*)"\x35\x0a" "from_bytes",
(const byte*)"\x37\x08" "fromkeys",
(const byte*)"\x27\x08" "function",
(const byte*)"\x96\x09" "generator",
(const byte*)"\x33\x03" "get",
(const byte*)"\xc0\x07" "getattr",
(const byte*)"\x9d\x07" "globals",
(const byte*)"\x8c\x07" "hasattr",
(const byte*)"\xb7\x04" "hash",
(const byte*)"\x70\x03" "hex",
(const byte*)"\x28\x02" "id",
(const byte*)"\x7b\x05" "index",
(const byte*)"\x12\x06" "insert",
(const byte*)"\x16\x03" "int",
(const byte*)"\xeb\x07" "isalpha",
(const byte*)"\xa8\x07" "isdigit",
(const byte*)"\xb6\x0a" "isinstance",
(const byte*)"\xfc\x07" "islower",
(const byte*)"\x5b\x07" "isspace",
(const byte*)"\xb5\x0a" "issubclass",
(const byte*)"\xdd\x07" "isupper",
(const byte*)"\xe3\x05" "items",
(const byte*)"\x8f\x04" "iter",
(const byte*)"\x47\x08" "iterator",
(const byte*)"\xa7\x04" "join",
(const byte*)"\x32\x03" "key",
(const byte*)"\x01\x04" "keys",
(const byte*)"\xc5\x0a" "lcd_python",
(const byte*)"\x62\x03" "len",
(const byte*)"\x27\x04" "list",
(const byte*)"\x89\x06" "little",
(const byte*)"\x3b\x06" "locals",
(const byte*)"\xc6\x05" "lower",
(const byte*)"\xe5\x06" "lstrip",
(const byte*)"\xb9\x03" "map",
(const byte*)"\xb1\x03" "max",
(const byte*)"\x0b\x0b" "micropython",
(const byte*)"\xaf\x03" "min",
(const byte*)"\xbf\x06" "module",
(const byte*)"\x42\x04" "next",
(const byte*)"\x90\x06" "object",
(const byte*)"\xfd\x03" "oct",
(const byte*)"\xd1\x04" "open",
(const byte*)"\x87\x09" "opt_level",
(const byte*)"\x1c\x03" "ord",
(const byte*)"\xf3\x0a" "pend_throw",
(const byte*)"\x2a\x03" "pop",
(const byte*)"\xbf\x07" "popitem",
(const byte*)"\x2d\x03" "pow",
(const byte*)"\x54\x05" "print",
(const byte*)"\xa9\x07" "pybadge",
(const byte*)"\x1a\x05" "range",
(const byte*)"\x63\x06" "remove",
(const byte*)"\x49\x07" "replace",
(const byte*)"\xd0\x04" "repr",
(const byte*)"\x25\x07" "reverse",
(const byte*)"\xd2\x05" "rfind",
(const byte*)"\xe9\x06" "rindex",
(const byte*)"\xe7\x05" "round",
(const byte*)"\xa5\x06" "rsplit",
(const byte*)"\x3b\x06" "rstrip",
(const byte*)"\xb9\x04" "send",
(const byte*)"\x23\x03" "sep",
(const byte*)"\xd4\x07" "setattr",
(const byte*)"\x6c\x0a" "setdefault",
(const byte*)"\xbf\x04" "sort",
(const byte*)"\x5e\x06" "sorted",
(const byte*)"\xb7\x05" "split",
(const byte*)"\x85\x05" "start",
(const byte*)"\x74\x0a" "startswith",
(const byte*)"\x62\x0c" "staticmethod",
(const byte*)"\x57\x04" "step",
(const byte*)"\x9d\x04" "stop",
(const byte*)"\x50\x03" "str",
(const byte*)"\x29\x05" "strip",
(const byte*)"\x2e\x03" "sum",
(const byte*)"\xc4\x05" "super",
(const byte*)"\xb3\x05" "throw",
(const byte*)"\xd8\x08" "to_bytes",
(const byte*)"\xfd\x05" "tuple",
(const byte*)"\x9d\x04" "type",
(const byte*)"\xb4\x06" "update",
(const byte*)"\x27\x05" "upper",
(const byte*)"\x4e\x05" "value",
(const byte*)"\x7d\x06" "values",
(const byte*)"\xe6\x03" "zip",
# 107 "../../py/qstr.c" 2
...
# 119 "../../py/qstr.c"
void qstr_init(void) {
    (mp_state_ctx.vm.last_pool) = (qstr_pool_t*)&mp_qstr_const_pool;
    (mp_state_ctx.vm.qstr_last_chunk) = ((void *)0);
...
static const byte *find_qstr(qstr q) {
    ...
    qstr_pool_t *pool = (mp_state_ctx.vm.last_pool);
...
static qstr qstr_add(const byte *q_ptr) {
    ...
    if ((mp_state_ctx.vm.last_pool)->len >= (mp_state_ctx.vm.last_pool)->alloc) {
        qstr_pool_t *pool = ((qstr_pool_t*)m_malloc_maybe(sizeof(qstr_pool_t) + sizeof(const char*) * ((mp_state_ctx.vm.last_pool)->alloc * 2)));
        if (pool == ((void *)0)) {
            ;
            m_malloc_fail((mp_state_ctx.vm.last_pool)->alloc * 2);
        }
        pool->prev = (mp_state_ctx.vm.last_pool);
        pool->total_prev_len = (mp_state_ctx.vm.last_pool)->total_prev_len + (mp_state_ctx.vm.last_pool)->len;
        pool->alloc = (mp_state_ctx.vm.last_pool)->alloc * 2;
        pool->len = 0;
        (mp_state_ctx.vm.last_pool) = pool;
        (void)0;
    }


    (mp_state_ctx.vm.last_pool)->qstrs[(mp_state_ctx.vm.last_pool)->len++] = q_ptr;


    return (mp_state_ctx.vm.last_pool)->total_prev_len + (mp_state_ctx.vm.last_pool)->len - 1;
}
...
qstr qstr_find_strn(const char *str, size_t str_len) {
    ...
    for (qstr_pool_t *pool = (mp_state_ctx.vm.last_pool); pool != ((void *)0); pool = pool->prev) {
        for (const byte **q = pool->qstrs, **q_top = pool->qstrs + pool->len; q < q_top; q++) {
            if (((mp_uint_t)(*q)[0]) == str_hash && ((*q)[(1)]) == str_len && memcmp(((*q) + (1) + (1)), str, str_len) == 0) {
...
qstr qstr_from_strn(const char *str, size_t len) {
    ((void)((len < (1 << (8 * (1)))) ? 0 : (_fassert(186,"../../py/qstr.c","len < (1 << (8 * MICROPY_QSTR_BYTES_IN_LEN))",__FUNCTION__), 0)));
    ;
    ...
    if (q == 0) {
        ...
        size_t n_bytes = (1) + (1) + len + 1;

        if ((mp_state_ctx.vm.qstr_last_chunk) != ((void *)0) && (mp_state_ctx.vm.qstr_last_used) + n_bytes > (mp_state_ctx.vm.qstr_last_alloc)) {

            byte *new_p = ((byte*)(m_realloc_maybe(((mp_state_ctx.vm.qstr_last_chunk)), sizeof(byte) * ((mp_state_ctx.vm.qstr_last_alloc) + n_bytes), (0))));
            if (new_p == ((void *)0)) {

                (void)((byte*)(m_realloc_maybe(((mp_state_ctx.vm.qstr_last_chunk)), sizeof(byte) * ((mp_state_ctx.vm.qstr_last_used)), (0))));
                (mp_state_ctx.vm.qstr_last_chunk) = ((void *)0);
            } else {

                (mp_state_ctx.vm.qstr_last_alloc) += n_bytes;
            }
        }

        if ((mp_state_ctx.vm.qstr_last_chunk) == ((void *)0)) {

            size_t al = n_bytes;
            if (al < (128)) {
                al = (128);
            }
            (mp_state_ctx.vm.qstr_last_chunk) = ((byte*)(m_malloc_maybe(sizeof(byte) * (al))));
            if ((mp_state_ctx.vm.qstr_last_chunk) == ((void *)0)) {

                (mp_state_ctx.vm.qstr_last_chunk) = ((byte*)(m_malloc_maybe(sizeof(byte) * (n_bytes))));
                if ((mp_state_ctx.vm.qstr_last_chunk) == ((void *)0)) {
                    ;
            ...
            (mp_state_ctx.vm.qstr_last_alloc) = al;
            (mp_state_ctx.vm.qstr_last_used) = 0;
        }


        byte *q_ptr = (mp_state_ctx.vm.qstr_last_chunk) + (mp_state_ctx.vm.qstr_last_used);
        (mp_state_ctx.vm.qstr_last_used) += n_bytes;


        mp_uint_t hash = qstr_compute_hash((const byte*)str, len);
        do { (q_ptr)[0] = (hash); } while (0);
        do { (q_ptr)[(1)] = (len); } while (0);
        memcpy(q_ptr + (1) + (1), str, len);
        q_ptr[(1) + (1) + len] = '\0';
        q = qstr_add(q_ptr);
    }
    ;
...
mp_uint_t qstr_hash(qstr q) {
    return ((mp_uint_t)(find_qstr(q))[0]);
}
...
void qstr_pool_info(size_t *n_pool, size_t *n_qstr, size_t *n_str_data_bytes, size_t *n_total_bytes) {
    ...
    *n_str_data_bytes = 0;
    *n_total_bytes = 0;
    for (qstr_pool_t *pool = (mp_state_ctx.vm.last_pool); pool != ((void *)0) && pool != &mp_qstr_const_pool; pool = pool->prev) {
        *n_pool += 1;
        *n_qstr += pool->len;
        for (const byte **q = pool->qstrs, **q_top = pool->qstrs + pool->len; q < q_top; q++) {
            *n_str_data_bytes += ((1) + (1) + ((*q)[(1)]) + 1);
        }
