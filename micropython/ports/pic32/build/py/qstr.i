...
# 28 "../../py/qstr.c" 2
# 1 "/opt/microchip/xc32/v1.34/pic32mx/include/lega-c/string.h" 1
# 70 "/opt/microchip/xc32/v1.34/pic32mx/include/lega-c/string.h"
...
# 71 "/opt/microchip/xc32/v1.34/pic32mx/include/lega-c/string.h" 2
...
qstr qstr_from_strn(const char *str, size_t len) {
    ((void)((len < (1 << (8 * (1)))) ? 0 : (__assfail("Failed assertion `%s' at line %d of `%s'.\n", "len < (1 << (8 * MICROPY_QSTR_BYTES_IN_LEN))", 186, "../../py/qstr.c"), 0)));
    ;
