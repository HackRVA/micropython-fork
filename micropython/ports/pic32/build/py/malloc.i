...
# 290 "/opt/microchip/xc32/v1.34/pic32mx/include/lega-c/stdio.h"
    void clearerr(FILE *);
# 28 "../../py/malloc.c" 2
# 1 "/opt/microchip/xc32/v1.34/pic32mx/include/lega-c/stdlib.h" 1
# 81 "/opt/microchip/xc32/v1.34/pic32mx/include/lega-c/stdlib.h"
...
# 148 "/opt/microchip/xc32/v1.34/pic32mx/include/lega-c/stdlib.h"
...
# 72 "/opt/microchip/xc32/v1.34/pic32mx/include/lega-c/string.h"
...
# 34 "../../py/malloc.c" 2
# 72 "../../py/malloc.c"
static void *realloc_ext(void *ptr, size_t n_bytes, _Bool allow_move) {
    if (allow_move) {
...
void *m_realloc(void *ptr, size_t new_num_bytes) {
    ...
    if (new_ptr == ((void *)0) && new_num_bytes != 0) {
