...
void timerInit(void)
{
    ...
    ((IFS0CLR = 0x00000200), (IPC2CLR = 0x0000001C, IPC2SET = (((((1 << 15) | (5)) & 7)) << 0x00000002)), (IPC2CLR = 0x00000003, IPC2SET = (((((1 << 15) | (5)) >> 4) & 3) << 0x00000000)), (IEC0CLR = 0x00000200, IEC0SET = ((((1 << 15) | (5)) >> 15) << 0x00000009)));


    (T3CON = (((1 << 0x0000000F) | (0))&~((1 << 0x0000000F))), TMR3 = 0, PR3 = (((40000000L)/200)), T3CONSET=(((1 << 0x0000000F) | (0))&((1 << 0x0000000F))) );
    ((IFS0CLR = 0x00004000), (IPC3CLR = 0x0000001C, IPC3SET = (((((1<<15) | (2)) & 7)) << 0x00000002)), (IPC3CLR = 0x00000003, IPC3SET = (((((1<<15) | (2)) >> 4) & 3) << 0x00000000)), (IEC0CLR = 0x00004000, IEC0SET = ((((1<<15) | (2)) >> 15) << 0x0000000E)));


    (T4CON = (((1 << 0x0000000F) | (0))&~((1 << 0x0000000F))), TMR4 = 0, PR4 = (((40000000L)/38000)), T4CONSET=(((1 << 0x0000000F) | (0))&((1 << 0x0000000F))) );
    ((IFS0CLR = 0x00080000), (IPC4CLR = 0x0000001C, IPC4SET = ((((1<<15) | (3)) & 7) << 0x00000002)), (IPC4CLR = 0x00000003, IPC4SET = (((((1<<15) | (3)) >> 4) & 3) << 0x00000000)), (IEC0CLR = 0x00080000, IEC0SET = ((((1<<15) | (3)) >> 15) << 0x00000013)));
...
# 124 "timer1_int.c"
void __attribute__((vector(8), interrupt(IPL5SOFT), nomips16)) Timer2Handler(void)
{
   void do_audio();
   void do_leds();
 ...
 if (G_bitCnt > 31) {
     ...
     if (((IRpacketInNext+1) % 8) != IRpacketInCurr) {
  ...
  if ((IRpacketsIn[IRpacketInNext].p.badgeId == 0)
   ...
   | (IRpacketsIn[IRpacketInNext].p.badgeId == 666)
  ...
  if ((G_firstHalf + G_lastHalf) != 1) G_IRerror++;
...
void __attribute__((vector(7), interrupt(IPL6SOFT), nomips16)) Int1Interrupt(void)
{
...
void __attribute__((vector(16), interrupt(IPL3SOFT), nomips16)) Timer4Handler(void)
{
   doAudio();
   (IFS0CLR = 0x00080000);
}
...
void __attribute__((vector(12), interrupt(IPL2SOFT), nomips16)) Timer3Handler(void)
{
   doLED_PWM();
   (IFS0CLR = 0x00004000);
}
