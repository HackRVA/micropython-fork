...
# 1 "../../py/mperrno.h" 1
# 89 "../../py/mperrno.h"
# 1 "/opt/microchip/xc32/v1.34/bin/bin/../../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/errno.h" 1 3
# 29 "/opt/microchip/xc32/v1.34/bin/bin/../../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/errno.h" 3
extern int errno;
# 90 "../../py/mperrno.h" 2
# 9 "mp_main.c" 2
...
void do_str(const char *src, mp_parse_input_kind_t input_kind) {
    nlr_buf_t nlr;
    if ((nlr_push_tail(&nlr), setjmp((&nlr)->jmpbuf)) == 0) {
        mp_lexer_t *lex = mp_lexer_new_from_str_len(MP_QSTR__lt_stdin_gt_, src, strlen(src), 0);
        qstr source_name = lex->source_name;
        mp_parse_tree_t parse_tree = mp_parse(lex, input_kind);
        mp_obj_t module_fun = mp_compile(&parse_tree, source_name, MP_EMIT_OPT_NONE, 1);
...
const mp_obj_fun_builtin_var_t mp_builtin_open_obj = {{&mp_type_fun_builtin_var}, (((1) << 17) | (((0xffff)) << 1) | ((1) ? 1 : 0)), .fun.kw = mp_builtin_open};
