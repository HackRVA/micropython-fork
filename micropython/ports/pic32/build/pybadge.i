...
long long mp_binary_get_int(mp_uint_t size, _Bool is_signed, _Bool big_endian, const byte *src);
void mp_binary_set_int(mp_uint_t val_sz, _Bool big_endian, byte *dest, mp_uint_t val);
# 5 "pybadge.c" 2
...
static const mp_obj_fun_builtin_fixed_t pybadge_red_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_red};
static const mp_obj_fun_builtin_fixed_t pybadge_green_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_green};
static const mp_obj_fun_builtin_fixed_t pybadge_blue_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_blue};
static const mp_obj_fun_builtin_fixed_t pybadge_flare_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_flare};
static const mp_obj_fun_builtin_fixed_t pybadge_backlight_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_backlight};
static const mp_obj_fun_builtin_fixed_t pybadge_FbMoveX_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_FbMoveX};
static const mp_obj_fun_builtin_fixed_t pybadge_FbMoveY_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_FbMoveY};
static const mp_obj_fun_builtin_fixed_t pybadge_FbMove_obj = {{&mp_type_fun_builtin_2}, .fun._2 = pybadge_FbMove};
static const mp_obj_fun_builtin_fixed_t pybadge_FbMoveRelative_obj = {{&mp_type_fun_builtin_2}, .fun._2 = pybadge_FbMoveRelative};
static const mp_obj_fun_builtin_fixed_t pybadge_FbClear_obj = {{&mp_type_fun_builtin_0}, .fun._0 = pybadge_FbClear};
static const mp_obj_fun_builtin_fixed_t pybadge_FbColor_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_FbColor};
static const mp_obj_fun_builtin_fixed_t pybadge_FbBackgroundColor_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_FbBackgroundColor};
static const mp_obj_fun_builtin_fixed_t pybadge_FbCharacter_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_FbCharacter};
static const mp_obj_fun_builtin_fixed_t pybadge_FbPoint_obj = {{&mp_type_fun_builtin_2}, .fun._2 = pybadge_FbPoint};
static const mp_obj_fun_builtin_fixed_t pybadge_FbWriteLine_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_FbWriteLine};
static const mp_obj_fun_builtin_fixed_t pybadge_FbWriteString_obj = {{&mp_type_fun_builtin_2}, .fun._2 = pybadge_FbWriteString};
static const mp_obj_fun_builtin_fixed_t pybadge_FbSwapBuffers_obj = {{&mp_type_fun_builtin_0}, .fun._0 = pybadge_FbSwapBuffers};
static const mp_obj_fun_builtin_fixed_t pybadge_FbPushBuffer_obj = {{&mp_type_fun_builtin_0}, .fun._0 = pybadge_FbPushBuffer};
static const mp_obj_fun_builtin_fixed_t pybadge_FbLine_obj = {{&mp_type_fun_builtin_2}, .fun._2 = pybadge_FbLine};
static const mp_obj_fun_builtin_fixed_t pybadge_LCDBars_obj = {{&mp_type_fun_builtin_0}, .fun._0 = pybadge_LCDBars};
static const mp_obj_fun_builtin_fixed_t pybadge_LCDcolor_obj = {{&mp_type_fun_builtin_1}, .fun._1 = pybadge_LCDcolor};
static const mp_obj_fun_builtin_fixed_t pybadge_LCDputPixel_obj = {{&mp_type_fun_builtin_3}, .fun._3 = pybadge_LCDputPixel};


static const mp_map_elem_t pybadge_globals_table[] = {
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR___name__)) << 2) | 2)), ((mp_obj_t)((((mp_uint_t)(MP_QSTR_pybadge)) << 2) | 2)) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_red)) << 2) | 2)), (mp_obj_t)&(pybadge_red_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_green)) << 2) | 2)), (mp_obj_t)&(pybadge_green_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_blue)) << 2) | 2)), (mp_obj_t)&(pybadge_blue_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_flare)) << 2) | 2)), (mp_obj_t)&(pybadge_flare_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_backlight)) << 2) | 2)), (mp_obj_t)&(pybadge_backlight_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbMoveX)) << 2) | 2)), (mp_obj_t)&(pybadge_FbMoveX_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbMoveY)) << 2) | 2)), (mp_obj_t)&(pybadge_FbMoveY_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbMove)) << 2) | 2)), (mp_obj_t)&(pybadge_FbMove_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbMoveRelative)) << 2) | 2)), (mp_obj_t)&(pybadge_FbMoveRelative_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbClear)) << 2) | 2)), (mp_obj_t)&(pybadge_FbClear_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbColor)) << 2) | 2)), (mp_obj_t)&(pybadge_FbColor_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbBackgroundColor)) << 2) | 2)), (mp_obj_t)&(pybadge_FbBackgroundColor_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbCharacter)) << 2) | 2)), (mp_obj_t)&(pybadge_FbCharacter_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbPoint)) << 2) | 2)), (mp_obj_t)&(pybadge_FbPoint_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbWriteLine)) << 2) | 2)), (mp_obj_t)&(pybadge_FbWriteLine_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbWriteString)) << 2) | 2)), (mp_obj_t)&(pybadge_FbWriteString_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbSwapBuffers)) << 2) | 2)), (mp_obj_t)&(pybadge_FbSwapBuffers_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbPushBuffer)) << 2) | 2)), (mp_obj_t)&(pybadge_FbPushBuffer_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_FbLine)) << 2) | 2)), (mp_obj_t)&(pybadge_FbLine_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_LCDBars)) << 2) | 2)), (mp_obj_t)&(pybadge_LCDBars_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_LCDcolor)) << 2) | 2)), &(pybadge_LCDcolor_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_LCDputPixel)) << 2) | 2)), &(pybadge_LCDputPixel_obj) },
};

static const mp_obj_dict_t mp_module_pybadge_globals = { .base = {&mp_type_dict}, .map = { .all_keys_are_qstrs = 1, .is_fixed = 1, .is_ordered = 1, .used = (sizeof(pybadge_globals_table) / sizeof((pybadge_globals_table)[0])), .alloc = (sizeof(pybadge_globals_table) / sizeof((pybadge_globals_table)[0])), .table = (mp_map_elem_t*)(mp_rom_map_elem_t*)pybadge_globals_table, }, }
