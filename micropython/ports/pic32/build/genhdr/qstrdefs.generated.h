...
QDEF(MP_QSTR_flare, (const byte*)"\x99\x05" "flare")
QDEF(MP_QSTR_backlight, (const byte*)"\xb0\x09" "backlight")
QDEF(MP_QSTR_FbMoveX, (const byte*)"\xe8\x07" "FbMoveX")
QDEF(MP_QSTR_FbMoveY, (const byte*)"\xe9\x07" "FbMoveY")
QDEF(MP_QSTR_FbMove, (const byte*)"\xb0\x06" "FbMove")
QDEF(MP_QSTR_FbMoveRelative, (const byte*)"\x04\x0e" "FbMoveRelative")
QDEF(MP_QSTR_FbClear, (const byte*)"\xb8\x07" "FbClear")
QDEF(MP_QSTR_FbColor, (const byte*)"\x1c\x07" "FbColor")
QDEF(MP_QSTR_FbBackgroundColor, (const byte*)"\x92\x11" "FbBackgroundColor")
QDEF(MP_QSTR_FbCharacter, (const byte*)"\x98\x0b" "FbCharacter")
QDEF(MP_QSTR_FbPoint, (const byte*)"\x2d\x07" "FbPoint")
QDEF(MP_QSTR_FbWriteLine, (const byte*)"\xb2\x0b" "FbWriteLine")
QDEF(MP_QSTR_FbWriteString, (const byte*)"\x09\x0d" "FbWriteString")
QDEF(MP_QSTR_FbSwapBuffers, (const byte*)"\x67\x0d" "FbSwapBuffers")
QDEF(MP_QSTR_FbPushBuffer, (const byte*)"\xff\x0c" "FbPushBuffer")
QDEF(MP_QSTR_FbLine, (const byte*)"\x0f\x06" "FbLine")
QDEF(MP_QSTR_LCDBars, (const byte*)"\xec\x07" "LCDBars")
QDEF(MP_QSTR_LCDcolor, (const byte*)"\xf3\x08" "LCDcolor")
QDEF(MP_QSTR_LCDputPixel, (const byte*)"\xf7\x0b" "LCDputPixel")
...
QDEF(MP_QSTR_pybadge, (const byte*)"\xa9\x07" "pybadge")
